...
import com.openclassrooms.swingtutorial.listeners.MouseGlassListener;
import com.openclassrooms.swingtutorial.listeners.MouseGlassMotionListener;
import com.openclassrooms.swingtutorial.panels.MyGlassPane;

import javax.swing.*;
import java.awt.*;

//CTRL + SHIFT + O pour générer les imports
public class DragNDropFrameWithGhost extends JFrame {

    private MyGlassPane glass = new MyGlassPane();

    public DragNDropFrameWithGhost() {
